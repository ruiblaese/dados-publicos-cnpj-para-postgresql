...
func main() {
	...
	db.AutoMigrate(&LinhaPrincipal{})

	//os.Exit(0)

	var listaArquivosDescompactados []string
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_01\\K3241.K03200DV.D91128.L00001")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_02\\K3241.K03200DV.D91128.L00002")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_03\\K3241.K03200DV.D91128.L00003")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_04\\K3241.K03200DV.D91128.L00004")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_05\\K3241.K03200DV.D91128.L00005")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_06\\K3241.K03200DV.D91128.L00006")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_07\\K3241.K03200DV.D91128.L00007")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_08\\K3241.K03200DV.D91128.L00008")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_09\\K3241.K03200DV.D91128.L00009")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_10\\K3241.K03200DV.D91128.L00010")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_11\\K3241.K03200DV.D91128.L00011")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_12\\K3241.K03200DV.D91128.L00012")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_13\\K3241.K03200DV.D91128.L00013")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_14\\K3241.K03200DV.D91128.L00014")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_15\\K3241.K03200DV.D91128.L00015")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_16\\K3241.K03200DV.D91128.L00016")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_17\\K3241.K03200DV.D91128.L00017")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_18\\K3241.K03200DV.D91128.L00018")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_19\\K3241.K03200DV.D91128.L00019")
	listaArquivosDescompactados = append(listaArquivosDescompactados, "temp\\DADOS_ABERTOS_CNPJ_20\\K3241.K03200DV.D91128.L00020")
...
func LerArquivoESalvarNoBanco(arquivos []string, db *gorm.DB) {
	...
	for _, arquivo := range arquivos {
		...
		for scanner.Scan() {
			...
			if line[0] == '1' {
				linhaStruct := ConverteLinhaParaStruct(line)
...
func (LinhaPrincipal) TableName() string {
	return "empresas"
}
...
func ConverteLinhaParaStruct(linha string) LinhaPrincipal {
	...
	return LinhaPrincipal{
		...
		Uf:                         obtemValorDaLinha(linha, 683, 2),
		CodigoMunicipio:            obtemValorDaLinha(linha, 685, 4),
		Municipio:                  obtemValorDaLinha(linha, 689, 50),
...
func downloadTodosArquivosDeCnpj() {
	...
	for index := 1; index <= 20; index++ {
		aux := strconv.FormatInt(int64(index), 10)
		if len(aux) < 9 {
			aux = "0" + aux
		}
